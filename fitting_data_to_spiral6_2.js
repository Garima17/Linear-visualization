...
function draw_textbox(data, adjacent_nodes, activeNode, count, deg, bet, clo, eig){
  ...
  var svg = d3.select("#community_textbox")
      .html("<b>Node of interest: </b>"+ activeNode +"<br/>" +"<b>Degree: </b>"+ deg +"<br/>" +"<b>Closeness: </b>"+ clo +"<br/>" + "<b>Betweenness: </b>"+ bet +"<br/>" +"<b>Eigen: </b>"+ eig +"<br/>" + "<br/>" + "<b>Community:</b> "+ data[0].community + "<br/>" + "<b>Number of Nodes in Community:</b> "+ data.length + "<br/>" +"<br/>" +
